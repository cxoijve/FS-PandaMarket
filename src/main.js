...
async function testProductService() {
  ...
  const getProductResponse = await ProductService.getProduct(
    getProductListResponse[0].id
  );
...
async function testArticleService() {
  ...
  const getArticleResponse = await ArticleService.getArticle(
    getArticleListResponse[0].id
  );
